        ...
        - generic [ref=e188]:
          ...
          - generic [ref=e193]:
            - generic [ref=e194]:
              ...
              - generic [ref=e197]: 90ms
              - generic [ref=e198]: 平均 90ms
            ...
            - generic [ref=e261]:
              ...
              - generic [ref=e288]:
                ...
                - combobox "priority絞り込み" [ref=e310]:
                  ...
                  - option "低優先"
                - generic [ref=e311]:
                  - checkbox "要確認のみ" [checked] [ref=e312]
                  - generic [ref=e313]: 要確認のみ
                - generic [ref=e314]:
                  - checkbox "実績指標を優先取得" [checked] [ref=e315]
                  - generic [ref=e316]: 実績指標を優先取得
                - button "運用ビュー" [active] [ref=e317] [cursor=pointer]
                      ...
                      - columnheader "尺" [ref=e470] [cursor=pointer]:
                        - generic [ref=e471]:
                          ...
                          - generic [ref=e472]:
                            ...
                            - img [ref=e475]
                  - rowgroup [ref=e477]:
                    - 'row "1 Ad360広告A 0:15 F Ad360広告A HIT GLP-1 91% JP AI判定 広告主A 美容・コスメ 82 -- 遷移先: その他 GLP-1 AI 高信頼 高優先 score 92 実績指標を優先取得 要確認 low_confidence 1万 +800 ¥12万 再生増加 800 0:15" [ref=e478] [cursor=pointer]':
                      - cell "1" [ref=e479]:
                        - generic [ref=e482]: "1"
                      ...
                      - cell "高優先 score 92 実績指標を優先取得" [ref=e524]:
                        - generic [ref=e525]:
                          - generic [ref=e526]:
                            - generic [ref=e527]: 高優先
                            - generic [ref=e528]: score 92
                          - paragraph [ref=e529]: 実績指標を優先取得
                      - cell "要確認 low_confidence" [ref=e530]:
                        - generic [ref=e531]:
                          - generic [ref=e532]: 要確認
                          - generic [ref=e533]: low_confidence
                      - cell "1万 +800" [ref=e534]:
                        - generic [ref=e535]:
                          - img [ref=e536]
                          - generic [ref=e539]: 1万
                        - generic [ref=e540]: "+800"
                      - cell "¥12万 再生増加 800" [ref=e541]:
                        - generic [ref=e542]: ¥12万
                        - generic [ref=e543]: 再生増加 800
                      - cell "0:15" [ref=e544]
                - generic [ref=e545]:
                  - generic [ref=e546]:
                    - generic [ref=e547]: 4件中 1-4件を表示
                    - generic [ref=e548]: "(フィルター適用: 1件)"
                  - generic [ref=e549]:
                    - generic [ref=e550]:
                      - generic [ref=e551]: "表示件数:"
                      - combobox [ref=e552]:
                        - option "25件"
                        - option "50件" [selected]
                        - option "100件"
                    - generic [ref=e553]:
                      - text: 1 / 1 ページ
                      - generic [ref=e554]: (105ms)
                    - generic [ref=e555]:
                      - button "最初のページ" [disabled] [ref=e556]:
                        - img [ref=e557]
                      - button "前へ" [disabled] [ref=e559]
                      - button "1" [ref=e560] [cursor=pointer]
                      - button "次へ" [disabled] [ref=e561]
                      - button "最後のページ" [disabled] [ref=e562]:
                        - img [ref=e563]
            - generic [ref=e566]:
              - button "アクティビティフィード" [ref=e567] [cursor=pointer]:
                - generic [ref=e568]:
                  - img [ref=e569]
                  - generic [ref=e571]: アクティビティフィード
                - img [ref=e572]
              - paragraph [ref=e576]: 最近のアクティビティはありません
  - alert [ref=e577]
```