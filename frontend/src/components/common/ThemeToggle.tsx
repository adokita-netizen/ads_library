  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-lg transition-colors duration-200 ${
        compact
          ? "h-8 w-8 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800"
          : "h-9 w-9 border border-gray-200 bg-white text-gray-600 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-800"
      }`}
